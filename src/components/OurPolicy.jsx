...
const OurPolicy = () => {
  return (
    <div className='our-policies'>
      ...
      <div className='one-policy flex-col'>
        <img className='mx-auto' src={assets.exchange_icon} alt="" />
      ...
      <div className='one-policy'>
        <img className='mx-auto' src={assets.quality_icon} alt="" />
      ...
      <div className='one-policy'>
        <img className='mx-auto' src={assets.support_img} alt="" />
